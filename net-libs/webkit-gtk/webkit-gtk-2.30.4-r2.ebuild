...
IUSE="aqua +egl examples gamepad +geolocation gles2-only gnome-keyring +gstreamer gtk4 gtk-doc +introspection +jpeg2k +jumbo-build libnotify +opengl seccomp spell systemd wayland +X"
...
RDEPEND="
	...
	gtk4? ( x11-libs/gtk+:4[introspection?,wayland?,X?] )
