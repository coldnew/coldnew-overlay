...
PATCHES=(
	"${FILESDIR}/${P}-precisioninclude.patch"
	"${FILESDIR}/${P}-topodsedgeinclude.patch"
	"${FILESDIR}/${P}-occ-library-dir.patch"
#	"${FILESDIR}/${P}-0003-cMake-FindPySide2Tools.cmake-use-generator-option.patch"
#	"${FILESDIR}/${P}-missing-svgext.patch"
#	"${FILESDIR}/${P}-geom2dcurve.patch"
#	"${FILESDIR}/${P}-missing-qpp-include.patch"
...
[[ ${PV} == *pre20* ]] && S="${WORKDIR}/freecad-${PV}" || S="${WORKDIR}/FreeCAD-${PV}"
...
src_configure() {
	local mycmakeargs=(
		...
		-DFREECAD_USE_OCC_VARIANT="Official OpenCASCADE version"
		-DOCE_DIR="${CASROOT}"
		-DOCC_INCLUDE_DIR="${CASROOT}"/include/opencascade
		-DOCC_LIBRARY_DIR="${CASROOT}/$(get_libdir)"
		-DOpenCASCADE_LIBRARY_DIR="${CASROOT}/$(get_libdir)"
