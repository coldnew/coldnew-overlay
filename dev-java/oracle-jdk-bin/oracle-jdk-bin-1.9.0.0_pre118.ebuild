...
JCE_URI="https://jdk9.java.net/download/"
...
JRE_amd64="jre-${MY_PV}_linux-x64_bin.tar.gz"
JRE_x86="jre-${MY_PV}_linux-x86_bin.tar.gz"
...
for d in "${AT_AVAILABLE[@]}"; do
  ...
  if has ${d} "${JRE_AVAILABLE[@]}"; then
      SRC_URI+=" ( $(eval "echo \${$(echo JRE_${d/-/_})}") )"
  fi
	SRC_URI+=" )"
done
unset d
...
src_install() {
  ...
  mkdir jre/.systemPrefs || die
	...
	rm -rf "${ddest}"/jre/lib/fontconfig.*
