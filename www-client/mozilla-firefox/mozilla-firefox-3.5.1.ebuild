...
IUSE="bindist iceweasel java mozdevelop restrict-javascript pgo" # qt-experimental
...
#	mozconfig_annotate '' --with-system-png  #failed
	mozconfig_annotate '' --with-system-zlib
	mozconfig_annotate '' --with-system-bz2
	mozconfig_annotate '' --disable-debug
	mozconfig_annotate '' --enable-cpp-exceptions
	mozconfig_annotate '' --enable-cpp-rtti
